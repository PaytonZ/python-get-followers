...
#
# Created: Thu Jul 10 17:20:51 2014
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(9, 9, 721, 531))
        self.tabWidget.setUsesScrollButtons(False)
        self.tabWidget.setObjectName("tabWidget")
        self.accuontManager = QtGui.QWidget()
        self.accuontManager.setObjectName("accuontManager")
        self.tabWidget_2 = QtGui.QTabWidget(self.accuontManager)
        self.tabWidget_2.setGeometry(QtCore.QRect(10, 10, 691, 441))
        self.tabWidget_2.setTabPosition(QtGui.QTabWidget.West)
        self.tabWidget_2.setTabShape(QtGui.QTabWidget.Rounded)
        self.tabWidget_2.setIconSize(QtCore.QSize(64, 64))
        self.tabWidget_2.setElideMode(QtCore.Qt.ElideMiddle)
        self.tabWidget_2.setObjectName("tabWidget_2")
        self.tab = QtGui.QWidget()
        self.tab.setObjectName("tab")
        self.clientLabel = QtGui.QLabel(self.tab)
        self.clientLabel.setGeometry(QtCore.QRect(130, 50, 111, 16))
        self.clientLabel.setObjectName("clientLabel")
        self.clientNameText = QtGui.QLineEdit(self.tab)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.accuontManager), QtGui.QApplication.translate("MainWindow", "Account Manager", None, QtGui.QApplication.UnicodeUTF8))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.followersGetter), QtGui.QApplication.translate("MainWindow", "Followers Getter", None, QtGui.QApplication.UnicodeUTF8))
